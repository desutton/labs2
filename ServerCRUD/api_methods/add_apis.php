...
$insertQuery = "INSERT INTO API_Standards (APIingredient,APImobilePhase,APIcolumnId,APIpercent,APIother,APImanufacture,APIexpiration,APIdateOpened,APIstorageLocation,APIpotency,APIretested,APIresults,APImethod,APImolWeight) VALUES ('$ingredient','$mobilePhase','$columnId','$percent','$other','$manufacture','$expiration','$dateOpened','$storageLocation','$potency','$retested','$results','$method','$weight')";
