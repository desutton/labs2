...
$$("userDetail").load("/labs2/php/api_methods/SELECTz.php?tableName=usersCustomer&columnNames=users_firstname,users_lastname,users_name,users_displayName,users_pass,users_UUID,users_css&selectColumn=users_name&selectData=" + $userId + "&dataName=data&select=1");
...
function update_row() {
    ...
    var dataSumit2Users = '{"users_firstname":"' + firstname + '", "users_lastname":"' + lastname + '", "users_name":"' + username + '", "users_displayName":"' + displayname + '", "users_css":"' + usercss + '", "users_pass":"' + userpass + '"}';
...
function refresh_row() {
    ...
    webix.ajax().get("/labs2/php/api_methods/SELECTz.php?tableName=usersCustomer&columnNames=users_firstname,users_lastname,users_name,users_displayName,users_pass,users_UUID,users_css&selectColumn=users_name&selectData=" + $userId + "&dataName=data&select=1", function (text, data) {
        var userAuthor = text;
