...
///////////////////////////////////////////////////////////////////////////////
            ...
            rows: [
                {
                    ...
                    data: [
...

                        {
                            ...
                            submenu: [
                                ...
                                },
                                {
                                    ...
                                    id: "newSample",
                                    icon: "fas fa-file-pdf",
                                    iFrame: "../samplewatch/newsamplesubmission.php"
                                }
                            ]
                        },
                        {
                        ...
                        {id: 9, value: "Logout", icon: "fas fa-cogs", href: "../../php/logoutCust.php"}
                    ],
                    on: {
    ...
    //                                                                           //
    ///////////////////////////////////////////////////////////////////////////////
    webix.ajax().get("/labs2/php/api_methods/SELECTz.php?tableName=usersCustomer&columnNames=users_2accessLevel&selectColumn=users_name&selectData=" + userId + "&dataName=data&select=1", function (text, data) {
        var userAuthor = text;
        ...
        if (userAuthor.users_2accessLevel === null) {
            $$("mainMenu").hideItem(1);
            $$("mainMenu").hideItem("home");
            $$("mainMenu").hideItem("todos");
            $$("mainMenu").hideItem("maintRequest");
            ...
            $$("mainMenu").showItem("customerPortal");
            $$("mainMenu").showItem("newSample");
            $$("mainMenu").hideItem(4);
            $$("mainMenu").hideItem(5);
            ...
            $$("mainMenu").hideItem(8);
            $$("mainMenu").hideItem("requestForms");
            $$("mainMenu").hideItem("archives");
            console.log("Normal");
        } else if (userAuthor.users_2accessLevel === "0") {
            $$("mainMenu").showItem(1);
