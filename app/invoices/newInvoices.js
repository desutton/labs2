    ...
    body: {
        rows: [
            ...
            },
            {
                ...
                select: true,
                drag: true,
                //url: "http://localhost/labs2/php/api_methods/SELECT.php?tableName=prices&columnNames=prices_id%20AS%20id,prices_testDescription%20AS%20value&dataName=data&select=5"
                url: "http://localhost/labs2/php/api_methods/SELECTz.php?tableName=prices&columnNames=prices_id,prices_UUID,prices_testDescription,prices_unitPrice&dataName=data&select=5"
